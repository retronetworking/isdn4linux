...
unsigned long divasa_get_pci_bar (unsigned char bus, unsigned char func, int bar);
typedef void (*divasa_find_pci_proc_t)(int handle, unsigned char bus, unsigned char func);
