...
/*------------------------------------------------------------------*/
/* File: di.h                                                       */
/* Copyright (c) G. Diehl ISDN GmbH 1993-1998                       */
/*                                                                  */
/* IDI common code definitions                                      */
/*------------------------------------------------------------------*/
/*
...
typedef int (*stream_client_callback_proc_t)(void* client_context,
                                             int Id,
                                             int what,
                                             void* data,
                                             int length,
...
struct adapter_s {
  ...
  dword rx_stream[256];
  dword tx_stream[256];
  dword stream_irq[265];
  dword stream_irq_shadow[265];
  stream_client_callback_proc_t stream_callback[256];
  void* stream_callback_context[256];
  word tx_pos[256];
  word rx_pos[256];
