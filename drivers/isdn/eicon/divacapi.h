...
#define DTMF_PARAMETER_BUFFER_SIZE    10
...
struct _PLCI {
  ...
  byte          data_sent;
  byte          send_disc;
  byte          sig_assign_pending;
  byte          sig_remove_pending;
  byte          nl_remove_pending;
  byte          b_channel;
  byte          adv_nl;
  byte          manufacturer;
  byte          call_dir;
...
#define T30_CONTROL_BIT_ALL_FEATURES  (T30_CONTROL_BIT_ENABLE_ECM | T30_CONTROL_BIT_ENABLE_2D_CODING |   T30_CONTROL_BIT_ENABLE_T6_CODING | T30_CONTROL_BIT_ENABLE_UNCOMPR)
...
#define CONNECTED               6
#define OUTG_DIS_PENDING        7
#define INC_DIS_PENDING         8
#define LOCAL_CONNECT           9
#define INC_RES_PENDING         10
#define OUTG_RES_PENDING        11
#define SUSPENDING              12
#define ADVANCED_VOICE_SIG      13
#define ADVANCED_VOICE_NOSIG    14
#define RESUMING                15
#define LISTEN_SIG_ASSIGN_PEND  16
...
#define ESC_CORNET       0x800|CORNETIE     /* Escape Cornet        */
...
#define CORNET_REQ_COMMAND              0x9023
#define CORNET_NC_REQ_COMMAND           0x9024
...
#define STD_INTERNAL_COMMAND_COUNT      32
...
struct li_config_bri_s {
  PLCI   *plci_table[MIXER_CHANNELS_BRI];
  byte current_table[MIXER_CHANNELS_BRI];
  byte channel_table[MIXER_CHANNELS_BRI];
  byte flag_table[MIXER_CHANNELS_BRI][MIXER_CHANNELS_BRI];
  byte coef_table[MIXER_CHANNELS_BRI][MIXER_CHANNELS_BRI];
};

struct li_config_pri_s {
  PLCI   *plci_table[MIXER_CHANNELS_PRI];
  byte current_table[MIXER_CHANNELS_PRI];
  byte channel_table[MIXER_CHANNELS_PRI];
  byte flag_table[MIXER_CHANNELS_PRI][MIXER_CHANNELS_PRI];
  byte coef_table[MIXER_CHANNELS_PRI][MIXER_CHANNELS_PRI];
};
...
#define LI_FLAG_CONFERENCE_TO      0x01
#define LI_FLAG_CONFERENCE_FROM    0x02
#define LI_FLAG_ANNOUNCEMENT       0x04
#define LI_FLAG_MIX                0x08
#define LI_FLAG_MONITOR            0x10

#define LI_COEF_CH_CH              0x0001
#define LI_COEF_CH_PC              0x0002
#define LI_COEF_PC_CH              0x0004
#define LI_COEF_PC_PC              0x0008

#define LI_REQ_SILENT_UPDATE       0xffff

#define MIXER_UDATA_REQUEST_SET_COEFS_BRI       24
#define MIXER_UDATA_REQUEST_SET_COEFS_PRI_SYNC  25
#define MIXER_UDATA_REQUEST_SET_COEFS_PRI_ASYN  26
#define MIXER_UDATA_INDICATION_COEFS_SET        24
...
#define SELECTOR_ECHO_CANCELLER        255
...
#define EC_CONTIGNUOUS_2100HZ_DETECTED      1
#define EC_PHASE_REVERSEDS_2100HZ_DETECTED  2
...
#define RTP_ADD_PAYLOAD_RED            0
#define RTP_ADD_PAYLOAD_CN_8000        1
#define RTP_ADD_PAYLOAD_DTMF           2
