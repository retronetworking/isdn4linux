...
#define	sysCFG			0x000000E0	/* GPIO 7,6,5: Input			*/
 	...
 	volatile u_int	i20GuestControl;/* Offset 2C					*/	
    		  						/* General purpose pins and		*/
   			  	  			  	   	/* guest bus control register	*/
...
#define	g_A4T_JADE_BOOTR 0x08000000	/* JADE enable boot SRAM (Low)	*/
									/* NOT USED 					*/
#define	g_A4T_ISAR_BOOTR 0x10000000	/* ISAR enble boot SRAM (Low)	*/
									/* NOT USED 					*/
